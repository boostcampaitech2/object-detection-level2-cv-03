# _base_=['/opt/ml/detection/mmdetection/configs/htc/htc_without_semantic_r50_fpn_1x_coco.py']
_base_ = [
    '/opt/ml/detection/mmdetection_new/configs/_base_/datasets/coco_instance.py',
...
MODEL_NAME ='pseudo_finetuning_multi_scale_HTC_swinB_pafpn_full_batch'

CV_VER = 1
BATCH_SIZE= 2

pretrained = '/opt/ml/detection/mmdetection_new/boostcamp/work_dirs/multi_scale_HTC_swinB_pafpn_full_batch/latest.pth'
...
train_pipeline = [
    ...
    #     ann_file =data_root + 'pseudo_test.json',
...
optimizer = dict(_delete_=True, type='AdamW', lr=0.0001/5, betas=(0.9, 0.999), weight_decay=0.05,
