...
s_patchroot = '/opt/ml/detection/Augs/sm_oversampled/s_patches'
m_patchroot = '/opt/ml/detection/Augs/sm_oversampled/m_patches'
dstroot = '/opt/ml/detection/Augs/sm_oversampled/result'
