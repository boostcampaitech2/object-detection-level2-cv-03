...
jf = '/opt/ml/detection/object-detection-level2-cv-03/1Phase/mmdetection/work_dirs/swinB_mc512864_fullAugs_defualtDS/pseudo/T_B_Univ_VFNswin_weight/train_aug.json'
