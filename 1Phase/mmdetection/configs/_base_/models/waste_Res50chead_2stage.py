    ...
    roi_head=dict(
        ...
        bbox_head=[
            dict(
                ...
                loss_bbox=dict(type='DIoULoss', loss_weight=5)),
            dict(
                type='Shared4Conv1FCBBoxHead',
                in_channels=256,
                conv_out_channels=512,
...
data = dict(
    ...
    test=dict(
        ...
        pipeline=[
            ...
            dict(
                type='MultiScaleFlipAug',
                img_scale=[(512, 512), (512, 512), (1024, 1024), (1024, 1024)],
...
log_config = dict(
    ...
    hooks=[
        ...
        dict(
            ...
            init_kwargs=dict(
                project='P-stage2-detection', name='waste_Res50chead_3stage'))
    ])
...
work_dir = './work_dirs/waste_Res50chead_3stage'
gpu_ids = range(0, 1)