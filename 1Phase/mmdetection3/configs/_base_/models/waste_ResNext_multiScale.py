    ...
    roi_head=dict(
        ...
        bbox_head=[
            dict(
                ...
                loss_bbox=dict(type='CIoULoss', loss_weight=5)),
            dict(
                type='Shared2FCBBoxHead',
                in_channels=256,
                conv_out_channels=512,
    ...
    val=dict(
        ...
        pipeline=[
            ...
            dict(
                ...
                img_scale=[(1024, 1024), (1024, 1024), (1024, 512), (1024, 512)],
...
log_config = dict(
    ...
    hooks=[
        ...
        dict(
            ...
            init_kwargs=dict(
                project='P-stage2-detection', name='waste_RexNext_multi_minbox_CIoU'))
    ])
...
work_dir = './work_dirs/waste_RexNext_multi_minbox_CIoU'
gpu_ids = range(0, 1)